...
% hold on
% plot(tdata, [0.03, 0.06, 0.13, 0.23, 4.66, 5.15, 5.54, 5.94, 6.57 , 5.66,5.45, 5.38 ], 'Color', 'r', 'Linestyle', 'none', 'Marker', '+')
% hold on
% plot(tdata, [0.01 ,0.01 , 0.01, 0.01 , 1.65, 1.73, 1.95, 2.39, 2.09, 1.8, 1.78, 1.76 ],  'Color', 'r', 'Linestyle', 'none', 'Marker', 'o')
% yyaxis left
% plot(tode,Y(:,1),tode, Y(:,2))
% hold on
% plot(tdata,[15.91, 15.44, 15.12, 14.39, 5.51, 4.93, 3.11, 1.90, 0.35 ,0.01 , 0.01, 0.01  ], 'Color', 'b', 'Linestyle', 'none', 'Marker', '*')
% hold on
% plot(tdata,[3.00 ,2.93, 2.76, 2.60, 1.49, 1.16, 0.86, 0.61, 0.39, 0.01,0.01, 0.01 ], 'Color', 'b', 'Linestyle', 'none', 'Marker', '^')
% hold on
% hax2 = axes('position', hax1.Position);
% plot(hax2, tode, Y(:,5), 'k')
% hold on
% plot(tdata,[ 0.01, 0.01, 0.01, 0.01, 0.0306, 0.0449, 0.0462, 0.0500, 0.0542 ,0.0551 ,0.0591, 0.0582 ], 'Color', 'k', 'Linestyle', 'none', 'Marker', '^')
% hax2.XLim = hax1.XLim; 
...
h_biomass_data = plot(tdata, ...
    [0.03, 0.06, 0.13, 0.23, 4.66, 5.15, 5.54, 5.94, 6.57, 5.66, 5.45, 5.38], ...
    'Color', 'r', 'LineStyle', 'none', 'Marker', '+');

h_phb_data = plot(tdata, ...
    [0.01, 0.01, 0.01, 0.01, 1.65, 1.73, 1.95, 2.39, 2.09, 1.8, 1.78, 1.76], ...
...
h_glucose_data = plot(tdata, ...
    [15.91, 15.44, 15.12, 14.39, 5.51, 4.93, 3.11, 1.90, 0.35, 0.01, 0.01, 0.01], ...
    'Color', 'b', 'LineStyle', 'none', 'Marker', '*');

h_nitrogen_data = plot(tdata, ...
    [3.00, 2.93, 2.76, 2.60, 1.49, 1.16, 0.86, 0.61, 0.39, 0.01, 0.01, 0.01], ...
...
h_ectoine_data = plot(hax2, tdata, ...
    [0.01, 0.01, 0.01, 0.01, 0.0306, 0.0449, 0.0462, 0.0500, 0.0542, 0.0551, 0.0591, 0.0582], ...
